export default {
  ...
  'wake.failed.title': 'Wake failed',
  'wake.success.title': 'Machine online',
  'wake.success.body': 'The machine is ready.',
  'session.inactive.resumeHint': 'Session is inactive. Sending will resume it automatically.',
  'session.inactive.machineOffline': 'Session is inactive and its machine is offline.',
  'session.inactive.wakeMachine': 'Wake machine',
  'session.inactive.wakingMachine': 'Waking…',
