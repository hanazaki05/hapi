export default {
  ...
  'wake.failed.title': '唤醒失败',
  'wake.success.title': '机器已上线',
  'wake.success.body': '机器已经可以接收会话。',
  'session.inactive.resumeHint': '会话已离线。发送消息会自动恢复。',
  'session.inactive.machineOffline': '会话已离线，所在机器也不在线。',
  'session.inactive.wakeMachine': '唤醒机器',
  'session.inactive.wakingMachine': '唤醒中…',
